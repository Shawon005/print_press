...
class PortalController extends Controller
{
    ...
    private function t(string $text): string
    {
        ...
        $map = [
            ...
            'Operations dashboard' => 'অপারেশনস ড্যাশবোর্ড',
            'Workspace Active' => 'সক্রিয় ওয়ার্কস্পেস',
            'Workspace Inactive' => 'নিষ্ক্রিয় ওয়ার্কস্পেস',
            'Workspace User' => 'ওয়ার্কস্পেস ইউজার',
            'Tenant Owner' => 'মালিক (ওনার)',
            ...
            'Open Orders' => 'চলমান অর্ডার',
            'Total Orders' => 'মোট অর্ডার',
            'Recent orders' => 'সাম্প্রতিক অর্ডার',
            'Open Rectangle Page' => 'রেকট্যাঙ্গেল পেজ দেখুন',
            'Open Die-Cut Page' => 'ডাই-কাট পেজ দেখুন',
            'Active Customers' => 'সক্রিয় কাস্টমার',
            'Pending Invoices' => 'বকেয়া ইনভয়েস',
            'Low Stock Alerts' => 'স্টক স্বল্পতার সতর্কতা',
            'Total Customers' => 'মোট কাস্টমার',
            'VIP Customers' => 'ভিআইপি কাস্টমার',
            'Lead Records' => 'লিড রেকর্ড',
            'Preferred' => 'পছন্দনীয়',
            'Supplier Dues' => 'সরবরাহকারীর বকেয়া',
            ...
            'Expense ledger' => 'খরচের খতিয়ান',
            'Delivery list' => 'ডেলিভারি তালিকা',
            'Out for Delivery' => 'ডেলিভারির জন্য প্রেরিত',
            'Sales Total' => 'মোট বিক্রি',
            'Expense Total' => 'মোট খরচ',
            'Receivables' => 'পাওনা (রিসিভেবল)',
            'Profit Estimate' => 'আনুমানিক লাভ',
            'Choose period and range' => 'সময়কাল এবং সীমা নির্বাচন করুন',
            'Revenue vs Expense vs Profit' => 'রাজস্ব বনাম খরচ বনাম লাভ',
            'Customer directory' => 'কাস্টমার ডিরেক্টরি',
            'Top Customer Report' => 'সেরা কাস্টমার রিপোর্ট',
            'Add User' => 'ইউজার যোগ করুন',
            'Add Paper Type' => 'কাগজের ধরন যোগ করুন',
            'View Reports' => 'রিপোর্ট দেখুন',
            'Export Reports' => 'রিপোর্ট এক্সপোর্ট করুন',
            'Add Role' => 'রোল যোগ করুন',
            'Add Ink Type' => 'কালির ধরন যোগ করুন',
            ...
            'View' => 'দেখুন',
            'Update' => 'আপডেট',
            'Apply Filter' => 'ফিল্টার প্রয়োগ করুন',
            'Period' => 'সময়কাল',
            'Monthly' => 'মাসিক',
            'Day' => 'দিন',
            'Month' => 'মাস',
